...
from robosuite_ohio.utils.camera_utils import CameraMover
from robosuite_ohio.utils.mjcf_utils import find_elements, find_parent
...
if __name__ == "__main__":
    ...
    if len(inp) == 0:
        ...
        print("This xml tag was copied from robosuite_ohio/models/assets/arenas/table_arena.xml")
