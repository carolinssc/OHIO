...
from robosuite_ohio.controllers.joint_vel import JointVelocityController
...
class InverseKinematicsController(JointVelocityController):
    ...
    def setup_inverse_kinematics(self, load_urdf=True):
        ...
        self.robot_urdf = pjoin(
            os.path.join(robosuite_ohio.models.assets_root, "bullet_data"),
        ...
        from robosuite_ohio.controllers import get_pybullet_server
