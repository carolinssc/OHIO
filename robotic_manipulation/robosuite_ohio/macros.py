...
try:
    from robosuite_ohio.macros_private import *
except ImportError:
    import robosuite_ohio
    from robosuite_ohio.utils.log_utils import ROBOSUITE_DEFAULT_LOGGER
    ...
    ROBOSUITE_DEFAULT_LOGGER.warn("To setup, run: python {}/scripts/setup_macros.py".format(robosuite_ohio.__path__[0]))
