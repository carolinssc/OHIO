...
from robosuite_ohio.utils.observables import Observable
...
def load_object(
    ...
    primitive_shapes_path = {
        "box": os.path.join(robosuite_ohio.models.assets_root, "objects/meshes/cube.obj"),
        "cylinder": os.path.join(robosuite_ohio.models.assets_root, "objects/meshes/cylinder.obj"),
        "sphere": os.path.join(robosuite_ohio.models.assets_root, "objects/meshes/sphere8.obj"),
        "plane": os.path.join(robosuite_ohio.models.assets_root, "objects/meshes/cube.obj"),
    }
