...
from robosuite_ohio.utils.input_utils import input2action
from robosuite_ohio.utils.observables import Observable, create_gaussian_noise_corrupter, create_uniform_sampled_delayer
from robosuite_ohio.wrappers import VisualizationWrapper
...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        from robosuite_ohio.devices import Keyboard

        device = Keyboard(pos_sensitivity=args.pos_sensitivity, rot_sensitivity=args.rot_sensitivity)
    elif args.device == "spacemouse":
        from robosuite_ohio.devices import SpaceMouse
