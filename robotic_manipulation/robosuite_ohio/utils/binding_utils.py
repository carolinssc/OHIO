...
if _MUJOCO_GL not in ("disable", "disabled", "off", "false", "0"):
    ...
    if _SYSTEM == "Linux" and _MUJOCO_GL == "osmesa":
        from robosuite_ohio.renderers.context.osmesa_context import OSMesaGLContext as GLContext
    elif _SYSTEM == "Linux" and _MUJOCO_GL == "egl":
        from robosuite_ohio.renderers.context.egl_context import EGLGLContext as GLContext
    else:
        from robosuite_ohio.renderers.context.glfw_context import GLFWGLContext as GLContext
